...
class Engine {
    constructor(config) {
        this.events = new Hoot.EventManager();
        ...
        this.display = null;
        this.events.addListener("hoot-engine-config-loaded", function(event) {
...
class EventManager {
    ...
    dispatch(name, options) {
        ...
        const p = new Proxy(object, this.handler);
        console.log(p.name);
...
const Hoot = {
    ...
    Event: __webpack_require__(/*! ./Event */ "./Event.js"),
